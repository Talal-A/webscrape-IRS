...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Tax_Return_Preparer> taxPreparers = new ArrayList<>();
        ...
        try {
            ...
            PrintWriter writer = new PrintWriter("Tax Preparers.txt");
            ...
            if (sort_type == 'l' || sort_type == 'L') { // sort and display by last name
                ...
                for (Tax_Return_Preparer t : taxPreparers) {
                    ...
                    writer.println(t.getFullName() + ", " + t.getTelephone() + ", " + t.getName_Of_Business() + ", " + t.getAddress() + ", " + t.getCity_State_Zip() + "; ");
                }
            }
